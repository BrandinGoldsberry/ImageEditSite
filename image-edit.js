...
const gradientWrapDiv = document.getElementById("gradientWrap");
...
window.onload = (ev) => {
    document.getElementById("upload-image").addEventListener("change", (imageEvent) => {
        gradientWrapDiv.style.backgroundImage = "";
...
const buttonGrade = document.getElementById("autoGradient");
const previewImage = document.getElementById("preview");
var gradeJSBool = false;

buttonGrade.addEventListener("click", function(){
    if(gradeJSBool === false){
        Grade(document.querySelectorAll("#gradientWrap"));
        previewImage.style.boxShadow = "none";
        gradientWrapDiv.style.boxShadow = "box-shadow: 0px 0px 12px 0px rgba(0,0,0,0.25)";
        gradeJSBool = true;
    }else{
        gradientWrapDiv.style.backgroundImage = "none";
        gradeJSBool = false;
    }
});
